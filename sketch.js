...
function setup() {
  ...
  trex = createSprite(100,windowHeight-80,20,50);
  ...
  invisibleGround = createSprite(0,windowHeight-80,windowWidth,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(touches.length>0 ||keyDown("space") && trex.y >= windowHeight-150) {
      trex.velocityY = -12;
      touches = []
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth,500,40,10);
